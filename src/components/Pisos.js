...
// --------------------------------------------------------
// 1. SUB-COMPONENTES PUROS (Afuera de la función principal)
// --------------------------------------------------------
...
// Micro-componente creado para no repetir el SVG 4 veces en el CTA Final
...
const obras = [
  "/obra34.png", 
  "/portadapisollaneado2.jpeg", 
  "/portadaserviciopluma.jpg", 
  "/portadahormigonbombeo.jpg", 
  "/obra50.png", 
  "/portadahormigonoficial.JPG"
];
...
function Pisos() {
  ...
  return (
    <Container fluid className="px-0 pisos-container">
      ...
      {/* 3. SOLUCIONES/PAQUETES */}
      <section className="py-5 bg-dark">
        <Container>
          <h2 className="fw-bold mb-5 text-center text-white">SOLUCIONES INTEGRALES <span className="text-red">DRM 360™</span></h2>
          <Row className="g-4">
            {paquetesData.map((paquete, idx) => (
              <Col md={4} key={idx}>
      ...
      <section className="py-5 bg-white">
        <Container className="text-center">
          ...
          <div className="mt-5">
            <img 
              src="/Gemini_Generated_Image_9jdci99jdci99jdc.png" 
      ...
      {/* 7. CTA FINAL - Implementando el nuevo micro-componente */}
      <section className="py-5 bg-danger text-white">
        <Container className="text-center">
          ...
          <div className="lead mb-4">
            <CheckListItem text="Obtén una evaluación gratuita con nuestros especialistas" />
            <CheckListItem text="Servicio sin retrasos por falta de coordinación entre proveedores" />
            <CheckListItem text="Sin sobreprecios al contratar servicios por separado" />
            <CheckListItem text="4 servicios en 1, con garantía unificada FULLCOVER™" />
          </div>
          <ContactButton 
            text="CONTACTAR AHORA" 
            variant="light" 
            className="px-5 py-3 fw-bold shadow text-danger" 
          />
        </Container>
      </section>
