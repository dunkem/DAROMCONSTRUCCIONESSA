...
// --------------------------------------------------------
// 1. DATOS ESTÁTICOS (Fuera del componente, sin useMemo)
// --------------------------------------------------------
const benefits = [
  { 
...
const pumpingEquipment = [
  { src: '/bombaarrastre.png', alt: 'Bomba de arrastre' },
  { src: '/bombapluma.png', alt: 'Bomba pluma' }
];

// --------------------------------------------------------
// 2. SUB-COMPONENTES PUROS (Fuera de la función principal)
// --------------------------------------------------------
const ContactButton = ({ text = "CONTACTAR ASESOR", variant = "danger", size = "lg", className = "", center = false }) => (
...
const GoogleRatingBadge = () => (
  <a href="#reviews" className="d-inline-flex align-items-center text-decoration-none py-2 px-3 google-rating-badge">
...
const LomaNegraBadge = () => (
  <div className="loma-negra-badge">
    <p className="badge-label">ALIADO ESTRATÉGICO</p>
    <img src="/logolomanegra.png" alt="Loma Negra Partner" className="loma-negra-logo" loading="lazy" />
  </div>
);

const BenefitCard = ({ benefit, index, isActive, onHover }) => (
  <div 
  ...
  >
    <div className="hormigon-benefit-logo-container">
      <img src={benefit.src} alt={benefit.title} className="hormigon-benefit-img" loading="lazy" />
    </div>
...
// Helper para renderizar los items del carrusel agrupados
...
function Hormigon() {
  ...
  const handleVideoLoadedData = () => {
    ...
    // Intentar auto-reproducir solo en pantallas de escritorio
    ...
    <Container fluid className="px-0 hormigon-container">
              ...
              <Col xs={12} lg={10} className="text-center">
                <div className="hormigon-hero-content-wrapper">
                  ...
                  <div className="hormigon-benefits-grid mb-5">
                    {['Producción bajo normas IRAM', 'Bombeo profesional con equipos modernos', 'Control de calidad en tiempo real', 'Seguimiento satelital de cada entrega'].map((benefit, idx) => (
      ...
      <section id="tipos-hormigon" className="hormigon-types-section py-5">
        <Container>
          ...
          <Carousel indicators={true} interval={4000} touch={true} pause="hover" variant="dark">
          ...
          <div className="text-center mt-4">
            <ContactButton text="CONSULTAR POR RESISTENCIAS ESPECIALES" size="md" center={true} />
          </div>
        </Container>
      </section>
        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="pe-lg-5 mb-4 mb-lg-0">
              ...
              <p className="mb-4 fs-5 text-white">Hemos desarrollado un servicio que integra todas las soluciones para tu obra:</p>
              <div className="hormigon-stats-features-grid mb-4">
                {['Control de calidad en tiempo real', 'Materiales certificados IRAM', 'Responsabilidad total garantizada', 'Asesoramiento técnico especializado'].map((feature, idx) => (
        ...
        <Container>
          <Row className="align-items-center">
            <Col lg={6} className="order-lg-2 ps-lg-5">
              ...
              <p className="hormigon-section-subtitle mb-4 text-dark">Soluciones completas para colocación de hormigón:</p>
              <div className="hormigon-features-grid mb-4">
                {['Bombas estacionarias CIFA SP 750 (50-100 m³/h)', 'Bombas pluma SX36/32 (hasta 130 m³/h)', 'Operadores certificados con amplia experiencia', 'Asesoramiento técnico sin cargo'].map((feature, idx) => (
                ...
                {pumpingEquipment.map((equipment, idx) => (
                  <Carousel.Item key={idx}>
                    <div className="pumping-image-container">
                      <img src={equipment.src} alt={equipment.alt} className="hormigon-pumping-img" loading="lazy" />
                    </div>
                  </Carousel.Item>
                ))}
              </Carousel>
      ...
      <section className="hormigon-suppliers-section py-5">
        <Container>
          ...
          <div className="suppliers-carousel-container">
            <Carousel indicators={false} interval={3000} pause="hover" touch={true} wrap={true}>
                ...
                <Carousel.Item key={slideIndex}>
                  <Row className="justify-content-center g-4">
                    {suppliers.slice(slideIndex * 6, (slideIndex + 1) * 6).map((supplier, idx) => (
                      <Col key={`${slideIndex}-${idx}`} md={2} sm={4} xs={6} className="text-center">
        ...
        <Container>
          <Row className="align-items-center">
            <Col md={6} className="pe-md-5">
              ...
              <div className="hormigon-features-grid mb-4">
                {['Hormigón elaborado bajo normas IRAM', 'Tecnología de última generación', 'Equipo técnico altamente capacitado', 'Soporte integral pre y post venta'].map((feature, idx) => (
                  <div key={idx} className="feature-item">
                    <FaCheckCircle className="hormigon-check-icon text-red" />
                    <span className="text-dark">{feature}</span>
                  </div>
            ...
            <Col md={6}>
              <img src="/IMG_3139.jpg" alt="Historia Darom SA" className="hormigon-about-img" loading="lazy" />
            </Col>
          </Row>
        </Container>
      </section>
